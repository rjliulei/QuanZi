...
import com.rjliulei.quanzi.CustomRecyclerScrollViewListener;
import com.rjliulei.quanzi.ItemTouchHelperClass;
import com.rjliulei.quanzi.R;
import com.rjliulei.quanzi.StoreRetrieveData;
import com.rjliulei.quanzi.ToDoItem;
import com.rjliulei.quanzi.service.TodoNotificationService;
import com.rjliulei.quanzi.view.RecyclerViewEmptySupport;
...
//                .setDefaultFontPath("fonts/Aller_Regular.tff").setFontAttrId(R.attr.fontPath).build());
        ...
        Typeface tf = Typeface.createFromAsset(getAssets(), "fonts/Aller_Regular.tff");
        tvEmpty.setTypeface(tf);
